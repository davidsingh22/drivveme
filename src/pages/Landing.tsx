...
const features = [
  { icon: TrendingDown, key: 'savings', color: 'text-accent', bgColor: 'bg-accent/10' },
  { icon: Clock, key: 'fast', color: 'text-primary', bgColor: 'bg-primary/10' },
  { icon: Shield, key: 'safe', color: 'text-success', bgColor: 'bg-success/10' },
  { icon: Headphones, key: 'support', color: 'text-warning', bgColor: 'bg-warning/10' },
];
      ...
      <div className="relative z-10">
        ...
        <section className="relative z-10 pt-32 pb-8 overflow-hidden min-h-[calc(100vh-64px)] flex flex-col justify-between">
          <div className="absolute inset-0 overflow-hidden">
            <motion.div className="absolute -top-1/2 -right-1/4 w-[800px] h-[800px] rounded-full bg-primary/5 blur-3xl"
          ...
          <div className="container mx-auto px-4 relative">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}
                ...
                Équitable pour les passagers. Équitable pour les chauffeurs.
              </motion.p>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {features.map((feature, index) => (
                <motion.div key={feature.key} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}
                  ...
                  <h3 className="font-display text-xl font-semibold mb-2">{t(`features.${feature.key}.title`)}</h3>
        ...
        <section className="py-20 gradient-primary">
          <div className="container mx-auto px-4">
            <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }}
              ...
              <h2 className="font-display text-4xl md:text-5xl font-bold text-primary-foreground mb-6">Ready to save on every ride?</h2>
              <p className="text-xl text-primary-foreground/80 mb-8">Join thousands of riders already saving money with Drivveme</p>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-2">
                ...
                <span className="font-display font-bold text-xl text-gradient">Drivveme</span>
              </div>
              <p className="text-muted-foreground text-sm">© {new Date().getFullYear()} Drivveme. All rights reserved.</p>
            </div>
          </div>
        </footer>
      </div>
